...
def function7():
    ...
    return np.zeros(len(x), dtype=np.int64) #write your code here
...
def function8():
    ...
    x = np.full((2,5),6, dtype=np.int64)#write your code here
...
def function9():
    ...
    a = np.arange(2,102, step=2)# write your code here
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.stack((arr, arr, arr), axis = -1) #write your code here 
    ans = np.concatenate(((ans.reshape(1, 9)), arr, arr, arr), axis = None)
    return ans
...
def function14():
    ...
    ans = np.reshape(arr, (8, 3)) #write your code here 
    ans = np.vsplit(ans, 4)
...
def function15():
    ...
    ans = np.reshape(arr, (3, 3))#write your code here 
    ans[[0, 1]] = ans[[1, 0]]
...
def function16():
    ...
    x = np.array([[1], [2], [3]])
    y = np.array([[2], [3], [4]])
    ans = np.concatenate((x[:3], y[:3]), axis=1) #write your code here 
...
def function18():
    ...
    x = piaic[(np.isin(piaic, students))] # Write you code Here
    x = x.size
    return x
